...
class AWS():
    upscalethreshold = 900
    downscaletime = 10 #minutes
    keyfile = '/home/ubuntu/installer/pythonscripts/akg.pem'    
    SSH_OPTS      = '-o StrictHostKeyChecking=no -i /home/ubuntu/installer/pythonscripts/akg.pem'
    prefix = "/home/ubuntu/"
    ...
    def createInstance(self,conn,size,name,type):
        ...
        ZONE            = 'RaceKVM' # Availability zone must match the volume's
        SECURITY_GROUPS = ['akg'] # Security group allows SSH        
        ...
        if(self.issshportopen(dnsname)):           
            ...
            for copy_dir in self.COPY_DIRS:
                ...
                command = "rsync -e \"ssh {0}\" -avz {2} root@{1}:{3}/ > /home/ubuntu/logs/rsynclogfile 2>&1".format(self.SSH_OPTS, dnsname, copy_dir,"/home/ubuntu/")
                print command
...
if __name__ == "__main__":
    ...
    logging.basicConfig(filename='python.log',evel=logging.DEBUG)
